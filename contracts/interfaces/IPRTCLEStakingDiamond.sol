...
interface IPRTCLEStakingDiamond {
    // diamond functions
    // struct Facet {
    ...
    function stringCost(uint256 _id) external pure returns (uint256 _sweatPrtclesCost);
    ...
    // get how many sweatPrtcles points an account has
    function sweatPrtcles(address _account) external view returns (uint256 sweatPrtcles_);
